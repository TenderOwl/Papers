...
void _bookSerialize(
  ...
  writer.writeBool(offsets[2], object.encrypted);
...
Book _bookDeserialize(
  ...
  object.encrypted = reader.readBool(offsets[2]);
...
extension BookQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> encryptedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension BookQuerySortBy on QueryBuilder<Book, Book, QSortBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> sortByEncrypted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'encrypted', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByEncryptedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQuerySortThenBy on QueryBuilder<Book, Book, QSortThenBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> thenByEncrypted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'encrypted', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByEncryptedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'encrypted', Sort.desc);
    });
  }
...
extension BookQueryWhereDistinct on QueryBuilder<Book, Book, QDistinct> {
  ...
  QueryBuilder<Book, Book, QDistinct> distinctByEncrypted() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQueryProperty on QueryBuilder<Book, Book, QQueryProperty> {
  ...
  QueryBuilder<Book, bool, QQueryOperations> encryptedProperty() {
    return QueryBuilder.apply(this, (query) {
